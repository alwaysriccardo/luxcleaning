  ...
  return (
    ...
    <div className="p-2 md:p-4 lg:p-6 w-full max-w-[1800px] mx-auto min-h-screen bg-[#Fdfcf8]">
      <div className="bg-[#Fdfcf8] rounded-[2.5rem] w-full relative flex flex-col border border-[#e5e2dd] shadow-sm overflow-hidden">
        ...
        <section id="reviews" className="py-20 bg-white border-b border-stone-200">
          <div className="max-w-7xl mx-auto px-6">
            {/* Google Reviews Badge & Stats */}
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-4 rounded-2xl border border-stone-200 shadow-lg mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <div className="text-2xl font-bold text-[#1a1a1a]">{t.reviews.rating}</div>
                      ...
                      <div className="bg-white rounded-2xl p-8 border border-stone-200 shadow-lg h-full">
                        ...
                        <div className="flex items-center gap-3 pt-4 border-t border-stone-100">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-stone-500">{t.reviews.customer}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      reviewIntervalRef.current = window.setInterval(() => {
                        setCurrentReviewIndex((prev) => (prev + 1) % 12);
                      }, 5000);
                    }}
                    className={`w-2 h-2 rounded-full transition-all ${
                      idx === currentReviewIndex ? 'bg-blue-600 w-8' : 'bg-stone-300'
                    }`}
                  />
                ))}
              </div>
