          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-16 border-b border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto mb-8">
              ...
              <a
                ...
                className="group relative bg-gradient-to-br from-[#1a1a1a] to-black border-2 border-white/20 rounded-2xl p-6 hover:border-yellow-400/50 hover:bg-gradient-to-br hover:from-yellow-400/10 hover:to-[#1a1a1a] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(251,191,36,0.3)]"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-yellow-400/20 group-hover:bg-yellow-400/30 flex items-center justify-center mb-4 transition-colors">
                    <Phone size={28} className="text-yellow-400" />
                  </div>
                  <div className="text-lg font-serif-display font-semibold mb-1 group-hover:text-yellow-400 transition-colors">
                    {t.footer.callNow}
                  </div>
              ...
              <a
                ...
                className="group relative bg-gradient-to-br from-[#1a1a1a] to-black border-2 border-white/20 rounded-2xl p-6 hover:border-[#25D366]/50 hover:bg-gradient-to-br hover:from-[#25D366]/10 hover:to-[#1a1a1a] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(37,211,102,0.3)]"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-[#25D366]/20 group-hover:bg-[#25D366]/30 flex items-center justify-center mb-4 transition-colors">
                  ...
                  <div className="text-lg font-serif-display font-semibold mb-1 group-hover:text-[#25D366] transition-colors">
                    {t.footer.whatsappUs}
                  </div>
                  <div className="text-sm text-stone-400 group-hover:text-stone-300 transition-colors">
                    {t.footer.getInstantQuote}
                  </div>
                </div>
              </a>
              ...
              <a
                href="mailto:luxcleaning@mail.ch"
                className="group relative bg-gradient-to-br from-[#1a1a1a] to-black border-2 border-white/20 rounded-2xl p-6 hover:border-blue-400/50 hover:bg-gradient-to-br hover:from-blue-400/10 hover:to-[#1a1a1a] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(59,130,246,0.3)]"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-14 h-14 rounded-full bg-blue-400/20 group-hover:bg-blue-400/30 flex items-center justify-center mb-4 transition-colors">
                    <Mail size={28} className="text-blue-400" />
                  </div>
                  <div className="text-lg font-serif-display font-semibold mb-1 group-hover:text-blue-400 transition-colors">
                    {t.footer.emailUs}
                  </div>
                  <div className="text-sm text-stone-400 group-hover:text-stone-300 transition-colors break-all">
                    luxcleaning@mail.ch
                  </div>
                </div>
              </a>
